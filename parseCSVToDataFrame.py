...
df = pd.read_csv('/Users/jkhunt/github/batteries-california/data/output_without_locations_2017.csv')
zipcode_df = pd.read_csv('/Users/jkhunt/github/batteries-california/data/US_Zipcodes.csv', skiprows = range(1, 30022))
